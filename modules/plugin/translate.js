...
function initialise() {
    axios({
        ...
        try {
            console.error(new Date().toString() + " ,腾讯翻译1： " + JSON.stringify(err));
        } catch (error) {
            console.error(new Date().toString() + " ,腾讯翻译1： " + err);
        }
...
function reaauth(qt = true) {
    axios({
        ...
        try {
            console.error(new Date().toString() + " ,腾讯翻译2： " + JSON.stringify(err));
        } catch (error) {
            console.error(new Date().toString() + " ,腾讯翻译2： " + err);
        }
        if (qt == true) {
            if (reaauth2 >= 0) {
...
function translate(sourceLang, targetLang, sourceText) {
    ...
    return axios({
        ...
        try {
            console.error(new Date().toString() + " ,腾讯翻译3: " + JSON.stringify(err));
        } catch (error) {
            console.error(new Date().toString() + " ,腾讯翻译3: " + err);
        }
    });
}
